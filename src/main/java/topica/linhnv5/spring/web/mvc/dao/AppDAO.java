...
public class AppDAO implements AppService {
	 ...
	 * Map of App
	 */
	private static final List<Application> listApp = new ArrayList<>();

	static {
		listApp.add(new Application("facebook", "Facebook", "https://image.winudf.com/v2/image1/Y29tLmZhY2Vib29rLmthdGFuYV9pY29uXzE1NTc5OTAwMzBfMDIz/icon.png?w=170&fakeurl=1", 4.5F,
				...
				"#"));
		listApp.add(new Application("messenger", "Messenger", "https://image.winudf.com/v2/image1/Y29tLmZhY2Vib29rLm9yY2FfaWNvbl8xNTU1NDY0Nzc5XzAxNQ/icon.png?w=170&fakeurl=1", 4.0F,
				...
				"#"));
		listApp.add(new Application("instagram", "Instagram", "https://image.winudf.com/v2/image1/Y29tLmluc3RhZ3JhbS5hbmRyb2lkX2ljb25fMTU1NTQ0NDM0N18wMTk/icon.png?w=170&fakeurl=1", 4.2F,
				...
				"#"));
		listApp.add(new Application("youtube", "Youtube", "https://image.winudf.com/v2/image1/Y29tLmdvb2dsZS5hbmRyb2lkLnlvdXR1YmVfaWNvbl8xNTU1MTE3NTQ3XzA5NA/icon.png?w=170&fakeurl=1", 4.0F,
				...
				"#"));
		listApp.add(new Application("steam", "Steam", "https://image.winudf.com/v2/image1/Y29tLnZhbHZlc29mdHdhcmUuYW5kcm9pZC5zdGVhbS5jb21tdW5pdHlfaWNvbl8xNTUyMDg4OTMzXzA3MQ/icon.png?w=170&fakeurl=1", 3.6F,
				...
				"#"));
		listApp.add(new Application("gamefly", "GameFly", "https://image.winudf.com/v2/image1/Y29tLmdhbWVmbHkuYW5kcm9pZC5nYW1lY2VudGVyX2ljb25fMTU1MjU1MjMxNV8wNTA/icon.png?w=170&fakeurl=1", 3.0F,
				...
				"#"));
		listApp.add(new Application("pupg", "PUPG Mobile", "https://image.winudf.com/v2/image1/Y29tLnRlbmNlbnQuaWdfaWNvbl8xNTYwMzA2NzY4XzA0Nw/icon.png?w=170&fakeurl=1", 3.5F,
				"Description\r\n" + 
				...
				"#"));
		listApp.add(new Application("hago", "HAGO", "https://image.winudf.com/v2/image1/Y29tLnl5LmhpeW9faWNvbl8xNTU1MzQyNTk1XzA4NQ/icon.png?w=170&fakeurl=1", 4.0F,
				...
				"#"));
		listApp.add(new Application("snapchat", "SnapChat", "https://image.winudf.com/v2/image1/Y29tLnNuYXBjaGF0LmFuZHJvaWRfaWNvbl8xNTU3MzI1OTc4XzA3MA/icon.png?w=170&fakeurl=1", 1.5F,
	...
	public List<Application> findByName(String name, int limit) {
		...
		for (Application app : listApp) {
			if (app.getTitle().startsWith(name)) {
				list.add(app);
	...
	public void updateApp(Application app) {
		listApp.set(listApp.indexOf(app), app);
	}

	@Override
	public void deleteAppById(String id) {
		for (Iterator<Application> iterator = listApp.iterator(); iterator.hasNext(); ) {
